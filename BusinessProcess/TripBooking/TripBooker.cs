...
namespace BusinessProcess.TripBooking
{
	public class TripBooker : ITripBooker
	{
		...
		public async Task<bool> BookTripAsync(Trip trip)
		{
			...
			//Book it!
			await _tripCommander.InsertTripAsync(new DataAccess.Dtos.TripDto(null, travelerId, trip.DepartureDate, trip.ReturnDate)).ConfigureAwait(false);
